"""
Script completo para arreglar el panel de administración de productos
Incluye:
1. Fix del error 403 en eliminación de productos
2. Reorganización de la tabla de productos
3. Filtros simplificados
4. Vinculación de categorías a la base de datos
"""
...
# 1. Fix views.py - Agregar método destroy explícito para manejar CSRF
views_py_content = """from rest_framework import viewsets, permissions, status
...
# Escribir el archivo views.py actualizado
views_path = r"c:\Users\Christopher\OneDrive\Desktop\Agroplace\Django\api\views.py"
with open(views_path, 'w', encoding='utf-8') as f:
    f.write(views_py_content)

print("✅ Backend views.py actualizado con fix de eliminación de productos")
